  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        {/* Title */}
        <h1 className="text-3xl font-bold text-center mb-3 text-gray-900">Crear Cuenta</h1>

        {/* Subtitle */}
        <p className="text-center text-gray-600 mb-8">Completa el formulario para registrarte en el sistema</p>
        ...
        <p className="text-center text-gray-600 mt-6">
          ...
          <Link href="/iniciar-sesion" className="text-blue-500 hover:text-blue-700 font-semibold transition">
            Inicia sesión aquí
          </Link>
        </p>
      </div>
